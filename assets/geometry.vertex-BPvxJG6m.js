...
`;e.ShadersStore[S]||(e.ShadersStore[S]=C);var w=[i,a,s,c,t,v,p,x,f,m,l,u,n,d,o,r,h];for(let t of w)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var T={name:S,shader:C};export{T as t};