...
`;e.ShadersStore[G]||(e.ShadersStore[G]=K);var q=[F,D,R,h,g,P,x,_,i,M,l,d,t,y,T,N,V,p,a,C,v,O,A,r,k,j,n,u,f,b,w,S,W,o,s,E,m,c];for(let t of q)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var J={name:G,shader:K};export{J as openpbrVertexShader};