import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./clipPlaneFragment-B_IgbgTE.js";import{t as n}from"./packingFunctions-DpGwbupU.js";import{t as r}from"./clipPlaneFragmentDeclaration-LJdlhFDo.js";import{t as i}from"./shadowMapFragment-DXnMjnBX.js";var a=`bayerDitherFunctions`,o=`float bayerDither2(vec2 _P) {return mod(2.0*_P.y+_P.x+1.0,4.0);}
...
}`;e.ShadersStore[d]||(e.ShadersStore[d]=f);var p=[n,s,u,r,t,i];for(let t of p)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var m={name:d,shader:f};export{m as t};