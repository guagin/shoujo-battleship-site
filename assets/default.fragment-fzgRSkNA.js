import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./helperFunctions-BH8P-eyq.js";import{t as n}from"./fresnelFunction-BmNPQIdN.js";import{t as r}from"./meshUboDeclaration-BATNZvmb.js";import{t as i}from"./sceneUboDeclaration-B96Tfx7b.js";import{t as a}from"./decalFragment-CvBK6CMD.js";import{n as o,t as s}from"./clipPlaneFragment-Ct2VqHzk.js";import{n as c,t as l}from"./fogFragment-EikOP4pH.js";import{t as u}from"./defaultUboDeclaration-DVoEMIF5.js";import{n as d,r as f,t as p}from"./reflectionFunction-3knPrqsc.js";import{a as m,c as h,i as g,l as _,n as v,o as y,r as b,s as x,t as S}from"./oitFragment-Cz_qD_Yv.js";import{t as C}from"./mainUVVaryingDeclaration-B_7d0nc3.js";import{n as w,t as T}from"./imageProcessingFunctions-B1IXC_gq.js";import{n as E,r as D,t as O}from"./bumpFragment-D2NLTOb5.js";import{t as k}from"./logDepthDeclaration-DYYUVTrx.js";import{t as A}from"./lightFragment-CHI52C6q.js";import{t as j}from"./logDepthFragment-CxtJswLx.js";var M=`clusteredLightingCompute`,N=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=N);var P={name:M,shader:N},F=`lightsFragmentFunctions`,I=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=I);var L={name:F,shader:I},R=`defaultPixelShader`,z=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[R]||(e.ShadersStoreWGSL[R]=z);var B=[i,r,u,f,_,h,C,t,x,y,m,P,L,g,d,n,p,w,T,b,D,E,o,k,c,s,O,a,v,A,j,l,S];for(let t of B)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var V={name:R,shader:z};export{V as defaultPixelShaderWGSL};