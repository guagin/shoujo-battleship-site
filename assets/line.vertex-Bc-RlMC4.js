...
}`;e.ShadersStore[h]||(e.ShadersStore[h]=g);var _=[d,s,c,m,t,o,r,n,i,a];for(let t of _)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var v={name:h,shader:g};export{v as t};