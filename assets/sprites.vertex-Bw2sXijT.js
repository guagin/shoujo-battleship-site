...
}`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=a);var o=[t,n,r];for(let t of o)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var s={name:i,shader:a};export{s as spritesVertexShaderWGSL};