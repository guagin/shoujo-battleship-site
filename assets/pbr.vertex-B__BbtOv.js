...
}`;e.ShadersStoreWGSL[L]||(e.ShadersStoreWGSL[L]=R);var z=[s,o,S,O,A,a,j,c,t,r,E,C,M,N,m,g,_,l,u,v,P,w,d,f,i,p,n,D,T,k,F,h,y,b,I,x];for(let t of z)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var B={name:L,shader:R};export{B as t};