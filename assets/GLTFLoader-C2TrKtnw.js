...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ol(e,t,n){return new us({name:`SphericalGaussianBlur`,defines:{SAMPLES:pl,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:jl(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function kl(){return new us({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:jl(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Al(){return new us({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:jl(),fragmentShader:`
