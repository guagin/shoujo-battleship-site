import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./imageProcessingDeclaration-D-Jk7MeR.js";import{t as n}from"./logDepthDeclaration-3gXGtHbI.js";import{t as r}from"./helperFunctions-gEnZbjN3.js";import{t as i}from"./imageProcessingFunctions-Cqomo2bJ.js";import{t as a}from"./fogFragmentDeclaration-kXoGw5iI.js";import{t as o}from"./clipPlaneFragment-B_IgbgTE.js";import{t as ee}from"./logDepthFragment-C5lxT4l1.js";import{t as te}from"./fogFragment-CKCGTcJi.js";import{t as ne}from"./clipPlaneFragmentDeclaration-LJdlhFDo.js";import{t as re}from"./sceneUboDeclaration-B5VhSG0v.js";import{t as ie}from"./meshUboDeclaration-BmNu2KU_.js";import{t as ae}from"./reflectionFunction-HDr5zz8L.js";import{t as oe}from"./lightFragmentDeclaration-gxhjod80.js";import{t as se}from"./lightUboDeclaration-DK1S79Am.js";import{t as ce}from"./ltcHelperFunctions-DS3Utz6C.js";import{t as le}from"./shadowsFragmentFunctions-Co6NG7kN.js";import{t as ue}from"./mainUVVaryingDeclaration-BBamQlxR.js";import{t as de}from"./pbrBRDFFunctions-BCNINF-p.js";import{t as fe}from"./harmonicsFunctions-QSz_WdsQ.js";import{t as pe}from"./objectIdFunctions-BCg-H1o3.js";import{a as me,i as he,n as ge,o as _e,r as ve,t as ye}from"./oitFragment-DFpWA9d0.js";import{a as be,c as xe,i as Se,n as Ce,o as we,r as Te,s as Ee,t as De}from"./pbrDebug-BBRIxot5.js";import{t as Oe}from"./samplerFragmentDeclaration-3yaLawFX.js";import{n as ke,t as Ae}from"./pbrIBLFunctions-CSlJv7qb.js";import{t as je}from"./subSurfaceScatteringFunctions-D1w5631e.js";import{n as Me,t as Ne}from"./hdrFilteringFunctions-Dw0rQ8Bu.js";import{t as Pe}from"./openpbrUboDeclaration-CbPGRvOI.js";import{t as Fe}from"./sceneFragmentDeclaration-ql3RpL9u.js";import{a as Ie,i as s,n as c,r as l,t as u}from"./openpbrSubsurfaceLayerData-DZgp0Qa4.js";var d=`openpbrFragmentDeclaration`,f=`uniform float vBaseWeight;uniform vec4 vBaseColor;uniform float vBaseDiffuseRoughness;uniform vec4 vReflectanceInfo;uniform vec4 vSpecularColor;uniform vec3 vSpecularAnisotropy;uniform float vTransmissionWeight;uniform vec3 vTransmissionColor;uniform float vTransmissionDepth;uniform vec3 vTransmissionScatter;uniform float vTransmissionScatterAnisotropy;uniform float vTransmissionDispersionScale;uniform float vTransmissionDispersionAbbeNumber;uniform float vSubsurfaceWeight;uniform vec3 vSubsurfaceColor;uniform float vSubsurfaceRadius;uniform vec3 vSubsurfaceRadiusScale;uniform float vSubsurfaceScatterAnisotropy;uniform float vCoatWeight;uniform vec3 vCoatColor;uniform float vCoatRoughness;uniform float vCoatRoughnessAnisotropy;uniform float vCoatIor;uniform float vCoatDarkening;uniform float vFuzzWeight;uniform vec3 vFuzzColor;uniform float vFuzzRoughness;uniform vec2 vGeometryCoatTangent;uniform float vGeometryThickness;uniform vec3 vEmissionColor;uniform float vThinFilmWeight;uniform vec2 vThinFilmThickness;uniform float vThinFilmIor;uniform float vGeometryThinWalled;uniform vec4 vLightingIntensity;uniform float visibility;uniform vec2 renderTargetSize;
#ifdef BASE_COLOR
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var Le={name:_,shader:v},y=`openpbrNormalMapFragmentFunctions`,b=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var x={name:y,shader:b},S=`openpbrConductorReflectance`,C=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=C);var Re={name:S,shader:C},w=`openpbrAmbientOcclusionFunctions`,T=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=T);var ze={name:w,shader:T},E=`openpbrVolumeFunctions`,D=`struct OpenPBRHomogeneousVolume {vec3 extinction_coeff; 
vec3 ss_albedo; 
...
weight_sum.b<1e-5f ? unconvolved_irradiance.b : irradiance_sum.b/weight_sum.b);}`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=D);var Be={name:E,shader:D},O=`openpbrNormalMapFragment`,k=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=k);var Ve={name:O,shader:k},A=`openpbrBlockNormalFinal`,j=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=j);var He={name:A,shader:j},M=`openpbrBaseLayerData`,N=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=N);var Ue={name:M,shader:N},P=`openpbrCoatLayerData`,F=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=F);var We={name:P,shader:F},I=`openpbrThinFilmLayerData`,L=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=L);var Ge={name:I,shader:L},R=`openpbrFuzzLayerData`,z=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=z);var Ke={name:R,shader:z},B=`openpbrAmbientOcclusionData`,V=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=V);var qe={name:B,shader:V},H=`openpbrBackgroundTransmission`,U=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=U);var Je={name:H,shader:U},W=`openpbrEnvironmentLighting`,G=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=G);var Ye={name:W,shader:G},K=`openpbrDirectLightingInit`,q=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=q);var Xe={name:K,shader:q},J=`openpbrDirectLighting`,Y=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=Y);var Ze={name:J,shader:Y},X=`openpbrBlockPrePass`,Z=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=Z);var Qe={name:X,shader:Z},Q=`openpbrPixelShader`,$=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStore[Q]||(e.ShadersStore[Q]=$);var $e=[pe,_e,me,Fe,he,p,re,ie,Pe,ue,xe,oe,se,Oe,ke,g,t,ne,n,a,ve,r,je,Me,Ee,i,le,fe,ce,we,be,de,Ne,Se,Ae,Le,x,ae,Ie,Re,ze,s,l,Be,o,Te,Ve,He,Ue,c,u,We,Ge,Ke,qe,ge,Je,Ye,Xe,Ze,ee,te,Ce,Qe,ye,De];for(let t of $e)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var et={name:Q,shader:$};export{et as t};