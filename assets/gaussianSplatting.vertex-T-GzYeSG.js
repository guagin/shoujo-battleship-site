...
`;e.ShadersStore[p]||(e.ShadersStore[p]=m);var h=[u,c,l,f,s,r,t,n,d,i,a,o];for(let t of h)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var g={name:p,shader:m};export{g as gaussianSplattingVertexShader};