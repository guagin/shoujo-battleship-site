import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./imageProcessingDeclaration-D-Jk7MeR.js";import{t as ee}from"./logDepthDeclaration-3gXGtHbI.js";import{t as te}from"./helperFunctions-gEnZbjN3.js";import{t as n}from"./imageProcessingFunctions-Cqomo2bJ.js";import{t as ne}from"./fogFragmentDeclaration-kXoGw5iI.js";import{t as re}from"./clipPlaneFragment-B_IgbgTE.js";import{t as ie}from"./logDepthFragment-C5lxT4l1.js";import{t as ae}from"./fogFragment-CKCGTcJi.js";import{t as oe}from"./clipPlaneFragmentDeclaration-LJdlhFDo.js";import{t as se}from"./sceneUboDeclaration-B5VhSG0v.js";import{t as ce}from"./meshUboDeclaration-BmNu2KU_.js";import{t as le}from"./clusteredLightingFunctions-BFCOODPn.js";import{t as ue}from"./reflectionFunction-HDr5zz8L.js";import{t as de}from"./lightFragmentDeclaration-gxhjod80.js";import{t as fe}from"./lightUboDeclaration-DK1S79Am.js";import{t as pe}from"./ltcHelperFunctions-DS3Utz6C.js";import{t as me}from"./shadowsFragmentFunctions-Co6NG7kN.js";import{t as he}from"./lightFragment-5DmvFIcs.js";import{t as ge}from"./pbrUboDeclaration--xFZEw0i.js";import{t as _e}from"./mainUVVaryingDeclaration-BBamQlxR.js";import{t as ve}from"./pbrBRDFFunctions-BCNINF-p.js";import{t as ye}from"./harmonicsFunctions-QSz_WdsQ.js";import{t as be}from"./objectIdFunctions-BCg-H1o3.js";import{a as xe,i as Se,n as Ce,o as we,r as Te,t as Ee}from"./oitFragment-DFpWA9d0.js";import{a as De,c as Oe,i as ke,n as Ae,o as je,r as Me,s as Ne,t as Pe}from"./pbrDebug-BBRIxot5.js";import{t as Fe}from"./samplerFragmentDeclaration-3yaLawFX.js";import{n as Ie,t as Le}from"./pbrIBLFunctions-CSlJv7qb.js";import{t as Re}from"./subSurfaceScatteringFunctions-D1w5631e.js";import{n as ze,t as Be}from"./hdrFilteringFunctions-Dw0rQ8Bu.js";import{t as Ve}from"./bumpFragmentMainFunctions-D9FnEtix.js";import{t as He}from"./bumpFragmentFunctions-Hq-zEncP.js";import{t as Ue}from"./decalFragment-DYiNNNYb.js";import{t as We}from"./bumpFragment-BeWLWDhL.js";var r=`pbrFragmentDeclaration`,i=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var Ge={name:r,shader:i},a=`samplerFragmentAlternateDeclaration`,o=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var Ke={name:a,shader:o},s=`pbrFragmentSamplersDeclaration`,c=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var qe={name:s,shader:c},l=`pbrBlockAlbedoOpacity`,u=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var Je={name:l,shader:u},d=`pbrBlockReflectivity`,f=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var Ye={name:d,shader:f},p=`pbrBlockAmbientOcclusion`,m=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var Xe={name:p,shader:m},h=`pbrBlockAlphaFresnel`,g=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var Ze={name:h,shader:g},_=`pbrBlockAnisotropic`,v=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var Qe={name:_,shader:v},y=`pbrBlockReflection`,b=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var $e={name:y,shader:b},x=`pbrBlockSheen`,S=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=S);var et={name:x,shader:S},C=`pbrBlockClearcoat`,w=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=w);var tt={name:C,shader:w},T=`pbrBlockIridescence`,E=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=E);var D={name:T,shader:E},O=`pbrBlockSubSurface`,k=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=k);var nt={name:O,shader:k},A=`pbrBlockReflectance0`,j=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=j);var rt={name:A,shader:j},M=`pbrClusteredLightingFunctions`,N=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=N);var it={name:M,shader:N},P=`pbrBlockNormalFinal`,F=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=F);var at={name:P,shader:F},I=`pbrBlockLightmapInit`,L=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=L);var ot={name:I,shader:L},R=`pbrBlockGeometryInfo`,z=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=z);var st={name:R,shader:z},B=`pbrBlockReflectance`,V=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=V);var ct={name:B,shader:V},H=`pbrBlockDirectLighting`,U=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=U);var lt={name:H,shader:U},W=`pbrBlockFinalLitComponents`,G=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=G);var ut={name:W,shader:G},K=`pbrBlockFinalUnlitComponents`,q=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=q);var dt={name:K,shader:q},J=`pbrBlockFinalColorComposition`,Y=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=Y);var ft={name:J,shader:Y},X=`pbrBlockPrePass`,Z=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=Z);var pt={name:X,shader:Z},Q=`pbrPixelShader`,$=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[Q]||(e.ShadersStore[Q]=$);var mt=[be,we,xe,Se,Ge,se,ce,ge,_e,Oe,de,fe,Fe,Ke,Ie,qe,t,oe,ee,ne,Te,te,Re,ze,Ne,n,me,ye,pe,je,De,ve,Be,ke,Le,Ve,He,ue,Ue,Je,Ye,Xe,Ze,Qe,$e,et,tt,D,nt,le,rt,it,re,Me,We,at,Ce,ot,st,ct,lt,he,ut,dt,ft,ie,ae,Ae,pt,Ee,Pe];for(let t of mt)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var ht={name:Q,shader:$};export{ht as t};