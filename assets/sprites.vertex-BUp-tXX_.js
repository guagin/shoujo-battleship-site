...
}`;e.ShadersStore[i]||(e.ShadersStore[i]=a);var o=[n,t,r];for(let t of o)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var s={name:i,shader:a};export{s as spritesVertexShader};