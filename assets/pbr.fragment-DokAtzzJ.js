import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./helperFunctions-BH8P-eyq.js";import{t as ee}from"./meshUboDeclaration-BATNZvmb.js";import{t as te}from"./sceneUboDeclaration-B96Tfx7b.js";import{t as ne}from"./decalFragment-CvBK6CMD.js";import{t as n}from"./clipPlaneFragmentDeclaration-DYuu9Qqk.js";import{t as r}from"./clipPlaneFragment-F6cElb9_.js";import{t as i}from"./clusteredLightingFunctions-DNqaoQCj.js";import{t as re}from"./logDepthDeclaration-DYYUVTrx.js";import{t as ie}from"./reflectionFunction-BvFXGAfy.js";import{t as ae}from"./imageProcessingDeclaration-Bb7hft1z.js";import{t as a}from"./lightUboDeclaration-tC-Focp5.js";import{t as oe}from"./ltcHelperFunctions-D8BySwCQ.js";import{t as se}from"./shadowsFragmentFunctions-BTj6RIto.js";import{t as ce}from"./imageProcessingFunctions-BdsOoAXj.js";import{t as le}from"./fogFragmentDeclaration-CWCikRBp.js";import{t as ue}from"./lightFragment-CHI52C6q.js";import{t as de}from"./logDepthFragment-CxtJswLx.js";import{t as fe}from"./fogFragment-C9E3EVJj.js";import{t as pe}from"./pbrUboDeclaration-BPdnc_7Y.js";import{t as me}from"./mainUVVaryingDeclaration-B_7d0nc3.js";import{t as he}from"./pbrBRDFFunctions-DxfbxN23.js";import{t as ge}from"./harmonicsFunctions-CMr56qfT.js";import{t as _e}from"./objectIdFunctions-0O_zsAzb.js";import{a as ve,i as ye,n as o,r as s,t as be}from"./oitFragment-COz-_Wb9.js";import{a as xe,c as Se,i as Ce,l as we,n as Te,o as Ee,r as De,s as Oe,t as ke,u as Ae}from"./pbrDebug-DJ80HT8z.js";import{t as je}from"./samplerFragmentDeclaration-CEHqUfAO.js";import{n as Me,t as Ne}from"./pbrIBLFunctions-b8fwQKtH.js";import{t as Pe}from"./subSurfaceScatteringFunctions-kzIx-1Od.js";import{n as Fe,t as Ie}from"./hdrFilteringFunctions-Da1yugu7.js";import{t as Le}from"./bumpFragmentMainFunctions-B84fMbkg.js";import{t as Re}from"./bumpFragmentFunctions-DbpDnX-7.js";import{t as ze}from"./bumpFragment-46KCSlZ3.js";var c=`samplerFragmentAlternateDeclaration`,l=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=l);var u={name:c,shader:l},d=`pbrFragmentSamplersDeclaration`,f=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=f);var p={name:d,shader:f},m=`pbrBlockAlbedoOpacity`,h=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=h);var Be={name:m,shader:h},g=`pbrBlockReflectivity`,_=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=_);var Ve={name:g,shader:_},v=`pbrBlockAmbientOcclusion`,y=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=y);var He={name:v,shader:y},b=`pbrBlockAlphaFresnel`,x=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[b]||(e.IncludesShadersStoreWGSL[b]=x);var Ue={name:b,shader:x},S=`pbrBlockAnisotropic`,C=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=C);var We={name:S,shader:C},w=`pbrBlockReflection`,T=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=T);var Ge={name:w,shader:T},E=`pbrBlockSheen`,D=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=D);var Ke={name:E,shader:D},O=`pbrBlockClearcoat`,k=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=k);var qe={name:O,shader:k},A=`pbrBlockIridescence`,j=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=j);var Je={name:A,shader:j},M=`pbrBlockSubSurface`,N=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=N);var Ye={name:M,shader:N},P=`pbrBlockNormalFinal`,F=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=F);var Xe={name:P,shader:F},I=`pbrBlockLightmapInit`,L=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=L);var Ze={name:I,shader:L},R=`pbrBlockGeometryInfo`,z=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=z);var Qe={name:R,shader:z},B=`pbrBlockReflectance`,V=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[B]||(e.IncludesShadersStoreWGSL[B]=V);var $e={name:B,shader:V},H=`pbrBlockDirectLighting`,U=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=U);var et={name:H,shader:U},W=`pbrBlockFinalLitComponents`,G=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=G);var tt={name:W,shader:G},K=`pbrBlockFinalUnlitComponents`,q=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[K]||(e.IncludesShadersStoreWGSL[K]=q);var nt={name:K,shader:q},J=`pbrBlockFinalColorComposition`,Y=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[J]||(e.IncludesShadersStoreWGSL[J]=Y);var rt={name:J,shader:Y},X=`pbrBlockPrePass`,Z=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=Z);var it={name:X,shader:Z},Q=`pbrPixelShader`,$=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[Q]||(e.ShadersStoreWGSL[Q]=$);var at=[_e,ve,ye,te,ee,pe,me,Ae,a,je,u,Me,p,ae,n,re,le,s,t,Pe,Fe,we,ce,se,ge,oe,Se,Oe,he,Ie,i,Ee,xe,Ce,Ne,Le,Re,ie,ne,Be,Ve,He,Ue,We,Ge,Ke,qe,Je,Ye,r,De,ze,Xe,o,Ze,Qe,$e,et,ue,tt,nt,rt,de,fe,Te,it,be,ke];for(let t of at)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var ot={name:Q,shader:$};export{ot as t};