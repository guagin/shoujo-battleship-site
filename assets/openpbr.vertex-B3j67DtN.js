...
}`;e.ShadersStoreWGSL[V]||(e.ShadersStoreWGSL[V]=H);var U=[s,o,P,D,k,a,A,c,t,r,T,S,j,L,m,g,_,l,u,v,M,C,d,f,i,p,n,E,w,O,B,h,y,b,N,x];for(let t of U)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var W={name:V,shader:H};export{W as t};