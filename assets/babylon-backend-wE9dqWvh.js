import{n as e}from"./rolldown-runtime-hePW80VL.js";import{C as t,b as n,c as r,g as i,t as a,y as o}from"./mesh.pure-ECA1_wkB.js";import{l as s,n as c}from"./scene.pure-Dic6ZcRQ.js";import{a as l,o as u,r as d,y as f}from"./particleSystemComponent-DEGjVblH.js";import{n as ee,r as p,t as m}from"./texture-BtN_L_oK.js";import{a as h,n as te,o as g,s as _,t as v}from"./math.vector.pure-DvOxp7ND.js";import{n as y,t as b}from"./math.color.pure-DiJ39ld0.js";import{t as x}from"./math.plane-Bo5K64MT.js";import{t as S}from"./baseTexture.pure-B_I2R0MX.js";import{n as C,t as w}from"./material.pure-DhgEF69j.js";import{t as T}from"./constants-DfNKfgSv.js";import{n as E}from"./texture.pure-BPVTPqcA.js";import{n as D,t as O}from"./effectRenderer.pure-DOoY4ghz.js";import{t as k}from"./shadowGenerator-DD8VwKIK.js";import{t as A}from"./pbrMaterial.pure-CrCvas57.js";import{t as ne}from"./rawCubeTexture-DqCKBXwl.js";import{t as j}from"./multiRenderTarget.pure-3N_HjzY-.js";import"./babylon-runtime-D01J63DY.js";import{r as re,t as ie}from"./babylon-impact-vfx-Bxq3inoR.js";import{t as M}from"./ocean-lighting-Bw4aVyNr.js";import{$t as N,A as P,Bt as ae,E as oe,G as F,Ht as I,Pt as se,Rt as ce,U as L,V as R,Xt as z,Z as B,cn as V,dt as H,et as U,f as W,ft as G,gt as K,ht as le,kt as q,ln as J,nt as ue,qt as de,tt as fe,un as Y,w as pe,y as X}from"./three.module-yU8Zk6W6.js";import{n as Z,r as me}from"./impact-vfx-BDLTYzOR.js";var Q=e({asmPass:()=>ve,bfPass:()=>_e,foamPass:()=>ye,h0Pass:()=>he,specPass:()=>ge}),he=`
...
`+r,t instanceof L?(r=`#include<instancesDeclaration>
...
`+e.fragmentShader).matchAll(/uniform\s+int\s+([^;]+);/g))for(let e of t[1].split(`,`))f.add(e.trim());return this.uniforms(e,d,f),d.onBindObservable.add(()=>this.uniforms(e,d,f)),d}uniforms(e,t,n){for(let r in e.uniforms){let i=e.uniforms[r].value;if(i instanceof N){let e=this.texture(i);e&&t.setTexture(r,e)}else if(i instanceof S)t.setTexture(r,i);else if(i instanceof v)t.setMatrix(r,i);else if(typeof i==`number`)n.has(r)?t.setInt(r,i):t.setFloat(r,i);else if(i instanceof X)t.setColor3(r,new b(i.r,i.g,i.b));else if(i instanceof V)t.setVector2(r,new h(i.x,i.y));else if(i instanceof J)t.setVector3(r,new g(i.x,i.y,i.z));else if(i instanceof Y)t.setVector4(r,new _(i.x,i.y,i.z,i.w));else if(i instanceof Float32Array)t.setFloats(r,Array.from(i));else if(Array.isArray(i)&&i.length){let e=i.flatMap(e=>e.toArray?e.toArray():e);i[0]instanceof Y?t.setArray4(r,e):i[0]instanceof J?t.setArray3(r,e):i[0]instanceof V?t.setArray2(r,e):t.setFloats(r,e)}}}material(e,t){let n=this.materials.get(e);if(n)return n;let r;if(t instanceof q){let t=e;if(this.scene.getEngine().isWebGPU){let n=new o(`point-billboards`,this.scene,{vertexSource:`precision highp float;
