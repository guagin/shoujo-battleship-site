import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./helperFunctions-BH8P-eyq.js";import{t as n}from"./sceneUboDeclaration-B96Tfx7b.js";import{t as r}from"./clipPlaneFragmentDeclaration-DYuu9Qqk.js";import{t as i}from"./clipPlaneFragment-F6cElb9_.js";import{t as a}from"./clusteredLightingFunctions-DNqaoQCj.js";import{t as o}from"./backgroundUboDeclaration-ClJLip40.js";import{t as s}from"./logDepthDeclaration-DYYUVTrx.js";import{t as c}from"./reflectionFunction-BvFXGAfy.js";import{t as l}from"./imageProcessingDeclaration-Bb7hft1z.js";import{t as u}from"./lightUboDeclaration-tC-Focp5.js";import{t as d}from"./ltcHelperFunctions-D8BySwCQ.js";import{n as f,t as p}from"./lightsFragmentFunctions-CcSvgq4S.js";import{t as m}from"./shadowsFragmentFunctions-BTj6RIto.js";import{t as h}from"./imageProcessingFunctions-BdsOoAXj.js";import{t as g}from"./fogFragmentDeclaration-CWCikRBp.js";import{t as _}from"./lightFragment-CHI52C6q.js";import{t as v}from"./logDepthFragment-CxtJswLx.js";import{t as y}from"./fogFragment-C9E3EVJj.js";var b=`intersectionFunctions`,x=`fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2f(-b+h,-b-h);}`;e.IncludesShadersStoreWGSL[b]||(e.IncludesShadersStoreWGSL[b]=x);var S={name:b,shader:x},C=`backgroundPixelShader`,w=`#include<backgroundUboDeclaration>
...
`;e.ShadersStoreWGSL[C]||(e.ShadersStoreWGSL[C]=w);var T=[n,o,t,c,l,u,d,a,f,p,m,h,s,r,g,S,i,_,v,y];for(let t of T)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var E={name:C,shader:w};export{E as t};