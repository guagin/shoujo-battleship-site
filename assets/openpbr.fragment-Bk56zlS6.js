import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./helperFunctions-BH8P-eyq.js";import{t as n}from"./meshUboDeclaration-BATNZvmb.js";import{t as r}from"./sceneUboDeclaration-B96Tfx7b.js";import{t as i}from"./clipPlaneFragmentDeclaration-DYuu9Qqk.js";import{t as a}from"./clipPlaneFragment-F6cElb9_.js";import{t as o}from"./clusteredLightingFunctions-DNqaoQCj.js";import{t as ee}from"./logDepthDeclaration-DYYUVTrx.js";import{t as te}from"./reflectionFunction-BvFXGAfy.js";import{t as ne}from"./imageProcessingDeclaration-Bb7hft1z.js";import{t as re}from"./lightUboDeclaration-tC-Focp5.js";import{t as ie}from"./ltcHelperFunctions-D8BySwCQ.js";import{t as ae}from"./shadowsFragmentFunctions-BTj6RIto.js";import{t as oe}from"./imageProcessingFunctions-BdsOoAXj.js";import{t as se}from"./fogFragmentDeclaration-CWCikRBp.js";import{t as ce}from"./logDepthFragment-CxtJswLx.js";import{t as le}from"./fogFragment-C9E3EVJj.js";import{t as ue}from"./mainUVVaryingDeclaration-B_7d0nc3.js";import{t as de}from"./pbrBRDFFunctions-DxfbxN23.js";import{t as fe}from"./harmonicsFunctions-CMr56qfT.js";import{t as pe}from"./objectIdFunctions-0O_zsAzb.js";import{a as me,i as he,n as ge,r as _e,t as ve}from"./oitFragment-COz-_Wb9.js";import{a as ye,c as be,i as xe,l as Se,n as Ce,o as we,r as Te,s as Ee,t as De,u as Oe}from"./pbrDebug-DJ80HT8z.js";import{t as ke}from"./samplerFragmentDeclaration-CEHqUfAO.js";import{n as Ae,t as je}from"./pbrIBLFunctions-b8fwQKtH.js";import{t as Me}from"./subSurfaceScatteringFunctions-kzIx-1Od.js";import{n as Ne,t as Pe}from"./hdrFilteringFunctions-Da1yugu7.js";import{t as s}from"./openpbrUboDeclaration-DsEnzkeE.js";import{a as c,i as l,n as u,r as d,t as f}from"./openpbrSubsurfaceLayerData-DpsV2wgM.js";var p=`openpbrFragmentSamplersDeclaration`,m=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var Fe={name:y,shader:b},x=`openpbrConductorReflectance`,S=`#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=T);var Ie={name:w,shader:T},E=`openpbrVolumeFunctions`,D=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=D);var Le={name:E,shader:D},O=`openpbrNormalMapFragment`,k=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=k);var Re={name:O,shader:k},A=`openpbrBlockNormalFinal`,j=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=j);var ze={name:A,shader:j},M=`openpbrBaseLayerData`,N=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=N);var Be={name:M,shader:N},P=`openpbrCoatLayerData`,F=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=F);var Ve={name:P,shader:F},I=`openpbrThinFilmLayerData`,L=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=L);var He={name:I,shader:L},R=`openpbrFuzzLayerData`,z=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=z);var Ue={name:R,shader:z},B=`openpbrAmbientOcclusionData`,V=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;e.IncludesShadersStoreWGSL[B]||(e.IncludesShadersStoreWGSL[B]=V);var We={name:B,shader:V},H=`openpbrBackgroundTransmission`,U=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=U);var Ge={name:H,shader:U},W=`openpbrEnvironmentLighting`,G=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=G);var Ke={name:W,shader:G},K=`openpbrDirectLightingInit`,q=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[K]||(e.IncludesShadersStoreWGSL[K]=q);var qe={name:K,shader:q},J=`openpbrDirectLighting`,Y=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStoreWGSL[J]||(e.IncludesShadersStoreWGSL[J]=Y);var Je={name:J,shader:Y},X=`openpbrBlockPrePass`,Z=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=Z);var Ye={name:X,shader:Z},Q=`openpbrPixelShader`,$=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[Q]||(e.ShadersStoreWGSL[Q]=$);var Xe=[pe,me,he,r,n,s,ue,Oe,re,ke,Ae,h,ne,i,ee,se,_e,t,Me,Ne,Se,oe,ae,fe,ie,be,Ee,de,Pe,o,we,ye,xe,je,v,Fe,te,c,C,Ie,l,d,Le,a,Te,Re,ze,Be,u,f,Ve,He,Ue,We,ge,Ge,Ke,qe,Je,ce,le,Ce,Ye,ve,De];for(let t of Xe)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var Ze={name:Q,shader:$};export{Ze as t};