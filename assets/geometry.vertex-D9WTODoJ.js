...
`;e.ShadersStore[S]||(e.ShadersStore[S]=C);var w=[i,o,u,f,t,v,l,x,c,h,d,p,n,a,s,r,m];for(let t of w)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var T={name:S,shader:C};export{T as geometryVertexShader};