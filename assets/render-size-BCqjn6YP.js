function e(e,t){return{x:t[0]*e.x+t[4]*e.y+t[8]*e.z+t[12]*e.w,y:t[1]*e.x+t[5]*e.y+t[9]*e.z+t[13]*e.w,z:t[2]*e.x+t[6]*e.y+t[10]*e.z+t[14]*e.w,w:t[3]*e.x+t[7]*e.y+t[11]*e.z+t[15]*e.w}}function t(e,t,n,r,i=!1){if(n<=0||r<=0||![e.x,e.y,e.z,e.w,t.x,t.y,t.z,t.w].every(Number.isFinite))return;let a=e=>[e.w+e.x,e.w-e.x,e.w+e.y,e.w-e.y,i?e.z:e.w+e.z,e.w-e.z,e.w-1e-7],o=a(e),s=a(t),c=0,l=1;for(let e=0;e<o.length;e++)if(o[e]<0&&s[e]<0||(o[e]<0?c=Math.max(c,o[e]/(o[e]-s[e])):s[e]<0&&(l=Math.min(l,o[e]/(o[e]-s[e]))),c>l))return;let u=i=>{let a=e.w+(t.w-e.w)*i;return{x:(1+(e.x+(t.x-e.x)*i)/a)*n/2,y:(1-(e.y+(t.y-e.y)*i)/a)*r/2}},d=u(c),f=u(l);return{x1:d.x,y1:d.y,x2:f.x,y2:f.y,endVisible:s.every(e=>e>=0)}}var n=`
