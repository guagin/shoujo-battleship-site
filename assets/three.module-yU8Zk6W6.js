...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Dl(e,t,n){return new ls({name:`SphericalGaussianBlur`,defines:{SAMPLES:fl,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Al(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ol(){return new ls({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Al(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function kl(){return new ls({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Al(),fragmentShader:`
	...
	`}var jl=class extends $t{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ba(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var nd={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function rd(e,t){let n=nd[t];return n===void 0?(H(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var id=new K;function ad(){return J.getLuminanceCoefficients(id),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${id.x.toFixed(4)}, ${id.y.toFixed(4)}, ${id.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
