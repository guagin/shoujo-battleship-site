...
`;e.ShadersStoreWGSL[p]||(e.ShadersStoreWGSL[p]=m);var h=[a,t,o,s,d,r,c,l,i,u,n,f];for(let t of h)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var g={name:p,shader:m};export{g as selectionVertexShaderWGSL};