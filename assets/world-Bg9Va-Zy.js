...
gl_FragColor.a*=pow(abs(dot(normalize(energyNormal),normalize(energyView))),2.0);`)},e.customProgramCacheKey=()=>`energy-soft-edge-v1`,e}var Bt=class{beamLayer;group=new L;seen=new WeakSet;arcs=new V(new P(1,1,1,6),Rt(`#d2ffff`,.95),4096);arcGlow=new V(this.arcs.geometry,zt(Rt(`#557fff`,.22)),4096);halo;debris=new V(new ct(1,0),new U({color:`#777367`,roughness:1}),384);map;particles;steam;detailBatches;slots=Array.from({length:48},()=>{let e=new L,t=new J(new P(1,1,1,24),zt(Rt(`#7950ff`,.3))),n=new J(t.geometry,zt(Rt(`#e7ffff`))),r=new J(new ct(1,3),zt(Rt(`#c4afff`,.65))),i=Array.from({length:3},()=>new J(new K(1,.035,6,64),Rt(`#a9cfff`,.7))),a=new J(new N(.92,1,64),Rt(`#d2dfff`,.4));a.rotation.x=-Math.PI/2;let o=new J(r.geometry,zt(Rt(`#ffe6bd`,.8)));return e.add(t,n,r,a,o,...i),this.group.add(e),{group:e,glow:t,core:n,orb:r,rings:i,wave:a,contact:o}});constructor(e){if(this.beamLayer=e,e&&new URLSearchParams(location.search).get(`energyDetails`)!==`legacy`){let e=this.slots[0];this.detailBatches={orb:new Lt(e.orb.geometry,`#c4afff`,48,!0),contact:new Lt(e.contact.geometry,`#ffe6bd`,48,!0),rings:new Lt(e.rings[0].geometry,`#a9cfff`,144),wave:new Lt(e.wave.geometry,`#d2dfff`,48)};for(let e of Object.values(this.detailBatches))this.group.add(e.mesh)}this.group.userData.excludeReflection=!0,this.debris.frustumCulled=!1,this.group.add(this.debris);let t=document.createElement(`canvas`);t.width=t.height=64;let n=t.getContext(`2d`),r=n.createRadialGradient(32,32,0,32,32,32);r.addColorStop(0,`#ffffffff`),r.addColorStop(.2,`#ffffffcc`),r.addColorStop(1,`#ffffff00`),n.fillStyle=r,n.fillRect(0,0,64,64),this.map=new Ye(t);let i=(e,t,n)=>{let r=new W;r.setAttribute(`position`,new Ie(new Float32Array(6144),3).setUsage(I)),r.setDrawRange(0,0);let i=new le(r,new Ge({size:e,color:t,map:this.map,transparent:!0,depthWrite:!1,opacity:n?.85:.22,blending:n?2:1}));return i.frustumCulled=!1,this.group.add(i),i};this.particles=i(1.5,`#b4b4ff`,!0),this.steam=i(12,`#cee1e7`,!1),this.halo=i(25,`#7860ff`,!0),this.halo.material.opacity=.12,this.arcs.frustumCulled=!1,this.arcGlow.frustumCulled=!1,this.group.add(this.arcGlow,this.arcs)}update(e){if(this.beamLayer?.update(e),this.detailBatches)for(let e of Object.values(this.detailBatches))e.reset();this.slots.forEach(e=>e.group.visible=!1),this.debris.count=0,this.arcs.count=this.arcGlow.count=0,this.halo.geometry.setDrawRange(0,0);let t=this.particles.geometry.attributes.position,n=this.steam.geometry.attributes.position,a=0,o=0,c=0,l=new F,u=this.halo.geometry.attributes.position,d=0;if(e.mode===`port`)return this.particles.geometry.setDrawRange(0,0),this.steam.geometry.setDrawRange(0,0),0;for(let t of e.beams){this.seen.has(t)||(this.seen.add(t),t.owner===e.player.id&&(c=1.4));let r=t.active?t.age??0:i-t.life;if(`terrain`in t&&t.terrain)for(let e=0;e<16&&this.debris.count<384;e++){let n=e*2.399,i=12+e*1.7;l.position.set(t.endX+Math.cos(n)*i*r,Math.max(.1,3+(15+e%5*4)*r-15*r*r),t.endZ+Math.sin(n)*i*r),l.rotation.set(r*e,n,r*4),l.scale.setScalar((1+e%3*.5)*Math.min(1,t.life*3)),l.updateMatrix(),this.debris.setMatrixAt(this.debris.count++,l.matrix)}let a=this.beamLayer?.contactParticles?0:Math.min(80,Math.ceil(Math.hypot(t.endX-t.x,t.endZ-t.z)/15));for(let e=0;e<a&&o<2048;e++){let i=(e+.5)/a,s=t.active?(r+e*.137)%1.8:r;n.setXYZ(o++,Re.lerp(t.x,t.endX,i)+Math.sin(e*7)*s*3,1+s*6,Re.lerp(t.z,t.endZ,i)+Math.cos(e*7)*s*3)}}this.debris.instanceMatrix.needsUpdate=!0;let f=[...e.ships.filter(t=>t.energyCharge!==void 0&&e.canSeeDirect(e.player,t)).map(t=>({...r(t,e.craters,e.ships,e.deployments.terrain,e.islands),owner:t.id,charge:1-t.energyCharge/s(t).charge,life:1,active:!1,age:0,heading:t.energyAim??t.aim})),...e.beams.map(e=>({...e,charge:-1,heading:Math.atan2(e.endX-e.x,e.endZ-e.z)}))];if(f.slice(0,48).forEach((r,c)=>{let f=this.slots[c],p=new Y(r.x,3,r.z),m=new Y(r.endX,3,r.endZ),h=m.clone().sub(p),g=r.charge>=0,_=r.active?r.age??0:i-r.life,v=g||r.active?1:Math.min(1,r.life/.65)**2,y=g?1:1+.08*Math.sin(_*24);f.group.visible=!0;let b=Math.floor(e.elapsed*16),x=e=>Math.sin(e*127.1+b*31.7+c*19.3),S=new Y(Math.sin(r.heading),0,Math.cos(r.heading)),C=new Y(Math.cos(r.heading),0,-Math.sin(r.heading)),ee=(e,t,n)=>{if(this.arcs.count>=4096)return;let r=t.clone().sub(e),i=r.length();i<.001||(l.position.copy(e).add(t).multiplyScalar(.5),l.quaternion.setFromUnitVectors(new Y(0,1,0),r.divideScalar(i)),l.scale.set(n,i,n),l.updateMatrix(),this.arcs.setMatrixAt(this.arcs.count,l.matrix),l.scale.set(n*7,i,n*7),l.updateMatrix(),this.arcGlow.setMatrixAt(this.arcs.count++,l.matrix))};if(!this.beamLayer||g)for(let e=0;e<3;e++){let t=g?18:h.length(),n=g?9:Math.min(64,Math.max(8,Math.ceil(t/15))),r=p.clone();for(let i=1;i<=n;i++){let a=i/n,o=e*Math.PI*2/3+a*8,s=g?(1-a)*12:5+x(i+e*80)*3,c=p.clone().addScaledVector(S,g?(a-.5)*t:a*t).addScaledVector(C,Math.cos(o)*s+x(i*3+e)*2);if(c.y+=Math.sin(o)*s*.7,ee(r,c,(g?.09:.16)*v),i%5==0){let e=c.clone().addScaledVector(C,x(i*9)*10);e.y+=4+x(i*2)*3,ee(c,e,.07*v)}r=c}}let te=g?1:this.beamLayer?0:Math.min(120,Math.ceil(h.length()/10));for(let e=0;e<te&&d<2048;e++){let t=g?0:e/te;u.setXYZ(d++,p.x+h.x*t,p.y,p.z+h.z*t)}for(let[t,n]of[[f.glow,g?.35:7],[f.core,g?.07:1.8]])t.visible=!this.beamLayer,t.visible&&(t.position.copy(p).add(m).multiplyScalar(.5),h.lengthSq()>0&&t.quaternion.setFromUnitVectors(new Y(0,1,0),h.clone().normalize()),t.scale.set(n*v*y*(s(e.ships[r.owner]).width/12),h.length(),n*v*y*(s(e.ships[r.owner]).width/12)),t.material.opacity=g?.25:v*(t===f.glow?.3:1));if(f.orb.position.copy(p),f.orb.scale.setScalar(g?.4+r.charge*2.5:(1.5+4*Math.exp(-_*14))*v),f.orb.material.opacity=g?.4+r.charge*.4:v*.8,f.rings.forEach((t,n)=>{t.position.copy(p).addScaledVector(new Y(Math.sin(r.heading),0,Math.cos(r.heading)),n*3),t.rotation.set(0,r.heading,e.elapsed*(n%2?1:-1)),t.scale.setScalar(g?(10-n*2)*(1-r.charge*.75):r.active?4+n*2+Math.sin(e.elapsed*5+n)*.4:3+_*(20+n*10)),t.material.opacity=g?.2+r.charge*.5:r.active?.65:Math.exp(-_*6)*.8}),f.wave.visible=!g,f.wave.position.set(r.x,.6,r.z),f.wave.scale.setScalar(3+45*(1-Math.exp(-Math.max(0,_)*5))),f.wave.material.opacity=g?0:Math.exp(-_*6)*.5,f.contact.visible=!g&&!!r.active&&`contact`in r&&!!r.contact,f.contact.visible&&(f.contact.position.copy(m),f.contact.scale.setScalar(4.5+Math.sin(e.elapsed*7)*.35),!this.beamLayer?.contactParticles)){for(let n=0;n<24&&a<2048;n++){let r=(e.elapsed+n*.073)%1.2,i=n*2.399,o=r*(5+n%5);t.setXYZ(a++,m.x+Math.cos(i)*o,3+r*(8+n%4)-r*r*4,m.z+Math.sin(i)*o)}for(let t=0;t<8&&o<2048;t++){let r=(e.elapsed+t*.23)%1.8;n.setXYZ(o++,m.x+Math.sin(t*7)*r*2,4+r*7,m.z+Math.cos(t*7)*r*2)}}let w=e.ships[r.owner]?.heading??r.heading,ne=Math.sin(w),T=Math.cos(w);if(g||!this.beamLayer?.contactParticles)for(let n=0;n<20&&a<2048;n++){let r=(n/20+e.elapsed*.6)%1,i=22+(1-r)*18,o=(n%2?1:-1)*3;t.setXYZ(a++,p.x-ne*i+T*o,3+Math.sin(r*Math.PI)*2,p.z-T*i-ne*o)}if(!g&&!this.beamLayer?.contactParticles)for(let t=0;t<12&&o<2048;t++){let r=(t/12+e.elapsed*.5)%1;n.setXYZ(o++,p.x-ne*30+T*Math.sin(t*7)*3,4+r*12,p.z-T*30-ne*Math.sin(t*7)*3)}if(g)for(let n=0;n<32&&a<2048;n++){let i=(n/32+e.elapsed*.7)%1,o=n*2.399+e.elapsed*2,s=2+(1-i)*15*(1-r.charge*.4);t.setXYZ(a++,p.x+Math.cos(o)*s,p.y+Math.sin(o*.7)*s*.7,p.z+Math.sin(o)*s)}if(this.detailBatches){let e=this.detailBatches;e.orb.add(f.orb),f.contact.visible&&e.contact.add(f.contact);for(let t of f.rings)e.rings.add(t);f.wave.visible&&e.wave.add(f.wave),f.group.visible=!1}}),this.detailBatches)for(let e of Object.values(this.detailBatches))e.flush();return this.arcGlow.count=this.arcs.count,this.arcs.instanceMatrix.needsUpdate=!0,this.arcGlow.instanceMatrix.needsUpdate=!0,u.needsUpdate=!0,this.halo.geometry.setDrawRange(0,d),this.halo.material.opacity=.12*Math.min(1,Math.max(0,...f.map(e=>e.charge>=0?.5+e.charge*.5:e.life/.65))),this.steam.material.opacity=.22*Math.min(1,Math.max(0,...e.beams.map(e=>e.life/.5))),t.needsUpdate=!0,n.needsUpdate=!0,this.particles.geometry.setDrawRange(0,a),this.steam.geometry.setDrawRange(0,o),c}dispose(){if(this.detailBatches)for(let e of Object.values(this.detailBatches))e.dispose();this.beamLayer?.dispose(),this.map.dispose();for(let e of[this.particles,this.steam,this.halo])e.geometry.dispose(),e.material.dispose(),e.removeFromParent()}},Vt=class{history=new Map;positions=new Float32Array(12288);geometry=new W;mesh;constructor(){this.geometry.setAttribute(`position`,new Ie(this.positions,3).setUsage(I)),this.geometry.setDrawRange(0,0),this.mesh=new rt(this.geometry,new B({color:`#ffd999`,transparent:!0,opacity:.65,blending:2,depthWrite:!1})),this.mesh.frustumCulled=!1,this.mesh.userData.excludeReflection=!0}update(e,t){let n=new Set,r=0;for(let i of e){if(i.kind===`torpedo`)continue;n.add(i.id);let e=this.history.get(i.id);e||(e=[],this.history.set(i.id,e)),t>0&&(e.unshift(new Y(i.x,i.y??3,i.z)),e.length>7&&e.pop());for(let t=1;t<e.length&&r<this.positions.length;t++)e[t-1].toArray(this.positions,r),e[t].toArray(this.positions,r+3),r+=6}for(let e of this.history.keys())n.has(e)||this.history.delete(e);if(this.geometry.setDrawRange(0,r/3),this.mesh.visible=r>0,r){let e=this.geometry.attributes.position;e.clearUpdateRanges(),e.addUpdateRange(0,r),e.needsUpdate=!0}}dispose(){this.geometry.dispose(),this.mesh.material.dispose(),this.mesh.removeFromParent()}},Ht=class{group=new L;signature=``;constructor(){this.group.name=`Weapon_ranges`,this.group.position.y=2,this.group.userData.excludeReflection=!0}update(e,t){if(this.group.visible=t,!t)return;this.group.position.set(e.x,2,e.z),this.group.rotation.y=e.heading;let r=[...new Set(e.battery.map(e=>e.weapon.range))].sort((e,t)=>e-t),i=e.secondaryGun?.range??0,o=JSON.stringify([r,i,a(e),e.secondaryBattery?.map(e=>[e.x,e.z,e.caliber])]);if(o===this.signature)return;this.signature=o,this.clear();let s=(e,t,n,r=!1)=>{let i=[];for(let t=0;t<256;t++){if(r&&t%4>=2)continue;let a=t/256*Math.PI*2,o=(t+1)/256*Math.PI*2;n((a+o)/2)&&i.push(Math.sin(a)*e,0,Math.cos(a)*e,Math.sin(o)*e,0,Math.cos(o)*e)}let a=new W;a.setAttribute(`position`,new M(i,3));let o=new rt(a,new B({color:t,transparent:!0,opacity:.7,depthWrite:!1,fog:!1}));o.renderOrder=10,this.group.add(o)};for(let t of r)s(t,`#8af4df`,()=>!0,t!==S(e));a(e)&&s(n.range+22,`#df9fff`,()=>!0,!0),i&&e.secondaryBattery?.length&&(s(i,`#ffbd72`,()=>!0,!0),s(i,`#ffbd72`,t=>e.secondaryBattery.some(e=>ee({x:0,z:0,heading:0},e,{x:Math.sin(t)*i,z:Math.cos(t)*i}))))}clear(){for(let e of[...this.group.children]){let t=e;t.geometry.dispose(),t.material.dispose(),this.group.remove(t)}}dispose(){this.clear(),this.group.removeFromParent()}},Ut=class{mesh;speed=0;previousSpeed=0;heading;turn=0;acceleration=0;constructor(e,t,n){let r=new W,i=[],a=[],o=[];for(let e=0;e<2;e++){let t=i.length/3;for(let[t,n]of[[-1,0],[1,0],[-1,1],[1,1]])i.push(t,0,n),a.push(e);o.push(t,t+2,t+1,t+1,t+2,t+3)}r.setAttribute(`position`,new M(i,3)),r.setAttribute(`washKind`,new M(a,1)),r.setIndex(o);let s=new H({transparent:!0,depthWrite:!1,side:2,uniforms:{wakeRoughness:{value:.1},foamMap:{value:n},time:{value:0},speed:{value:0},turn:{value:0},thrust:{value:0},width:{value:e},length:{value:t}},vertexShader:E,fragmentShader:ne});this.mesh=new J(r,s),this.mesh.name=`bow-and-propeller-wash`,this.mesh.frustumCulled=!1,this.mesh.visible=!1}update(e,t,n,r,i,a){let o=this.mesh.material.uniforms;if(!a){this.speed=0,this.turn=0,this.acceleration=0,this.heading=void 0,this.previousSpeed=i,this.mesh.visible=!1;return}if(e>0){let t=1-Math.exp(-e*5),n=this.heading===void 0?0:Math.atan2(Math.sin(r-this.heading),Math.cos(r-this.heading));this.turn+=(Re.clamp(n/e*4,-1,1)-this.turn)*t,this.acceleration+=(Re.clamp((Math.abs(i)-Math.abs(this.previousSpeed))/e/3,0,1)-this.acceleration)*t,this.speed+=(Math.min(1.6,Math.abs(i)/18)-this.speed)*t,this.heading=r,this.previousSpeed=i,o.time.value+=e}o.speed.value=this.speed,o.turn.value=this.turn,o.thrust.value=this.acceleration,this.mesh.position.set(t,0,n),this.mesh.rotation.y=r+(i<0?Math.PI:0),this.mesh.visible=this.speed>.025}dispose(){this.mesh.removeFromParent(),this.mesh.geometry.dispose(),this.mesh.material.dispose()}},Wt,Gt=0;function Kt(){return Gt++,Wt??=Nt()}var qt=class{width;length;mesh;history=new T;indices=new Uint16Array(762);positions=new Float32Array(768);data=new Float32Array(768);normals=new Float32Array(512);disposed=!1;wash;constructor(e,t){this.width=e,this.length=t;let n=new W;n.setAttribute(`position`,new Ie(this.positions,3).setUsage(I)),n.setAttribute(`wakeData`,new Ie(this.data,3).setUsage(I)),n.setAttribute(`wakeNormal`,new Ie(this.normals,2).setUsage(I));let r=[];for(let e=0;e<127;e++){let t=e*2;r.push(t,t+2,t+1,t+1,t+2,t+3)}n.setIndex(r),n.setDrawRange(0,0);let i=new H({transparent:!0,depthWrite:!1,side:2,uniforms:{wakeRoughness:{value:w.clear.wakeRoughness},surge:{value:0},wakeTime:{value:0},wakeWidth:{value:e},foamMap:{value:Kt()}},vertexShader:`attribute vec3 wakeData;attribute vec2 wakeNormal;uniform float wakeTime,wakeRoughness;uniform float wakeWidth;varying vec3 vWake;varying vec2 vWorld;
