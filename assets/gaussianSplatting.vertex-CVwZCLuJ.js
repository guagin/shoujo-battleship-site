...
`;e.ShadersStoreWGSL[d]||(e.ShadersStoreWGSL[d]=f);var p=[r,n,t,i,o,c,u,a,s,l];for(let t of p)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var m={name:d,shader:f};export{m as gaussianSplattingVertexShaderWGSL};