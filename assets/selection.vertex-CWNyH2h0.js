...
`;e.ShadersStore[p]||(e.ShadersStore[p]=m);var h=[i,a,s,c,f,t,l,u,n,d,o,r];for(let t of h)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var g={name:p,shader:m};export{g as selectionVertexShader};